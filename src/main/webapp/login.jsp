...
<%
  // Extract saved email from cookie
  String savedEmail = "";
    ...
    <div class="card">
      ...
      <form action="login" method="POST">
        <div class="form-group">
          ...
          <input type="email" id="email" name="email" value="<%= savedEmail %>" placeholder="john@example.com" required>
        </div>
        ...
        <div class="remember-group">
          <label class="checkbox-container">
            <input type="checkbox" name="rememberMe" value="true" <%= !savedEmail.isEmpty() ? "checked" : "" %>>
            Remember Me
          </label>
        </div>
